    ...
    <div style="margin-top: 20rem;">
        <section class="articles">
            <div class="column is-8 is-offset-2">
                <div class="card">
                    <h2 class="has-text-centered is-size-2">Editar seu artigo</h2>
                    @if($errors->any())
                        ...
                        <div class="card-content">
                            <div class="content">
                                @if ($artigo->image_location)
                                    <img src="{{ Storage::disk('public')->url($artigo->image_location) }}" width="400" height="400" alt="">
                                @endif
                                    <div class="field">
                                    <div class="control">
                                ...
                                <div class="field">
                                    <div class="control">
                                        ...
                                        <input class="input" type="text" name="title" placeholder="Título do artigo" value="{{ $artigo->title }}">
                                    </div>
                                </div>
                                <div class="field">
                                    <div class="control">
                                        <label for="texto">Texto:</label>
                                        <textarea class="textarea" id="texto" name="text" placeholder="Escreva aqui o texto do seu artigo"> {{ $artigo->text }} </textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
